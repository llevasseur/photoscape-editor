        ...
        JSON File { source }/psxproject.json : Updated!
                ...
                if ( n > 1 ):
                    ...
                    for i in range( 2, n + 1 ):
                        ...
                        start = canucks_i
                        canucks_so_i = 0
                        for j in range( start, min( len( canucks_scorers ), start + 7 ) ):
                            # Update CANUCKS SCORER
                            if so and canucks_i == len( canucks_scorers ) - 1:
                                ...
                                for k in range( j, canucks_so_n - ( j - start ) ):
                                    ...
                                    if k == j:
                                        ...
                                        skip = False
                                        is_initial = True
                                        text = make_shootout_text( canucks_scorers[ canucks_i ], skip, canucks_so_i, is_initial)
                                        canucks_so_i += 1
                                    else:
                                        ...
                                        skip = False
                                        is_initial = False
                                        number_of_spaces = 4 - ( min( canucks_so_n - canucks_so_i, 3 ) )
                                        text = make_shootout_text( canucks_scorers[ canucks_i ], skip, canucks_so_i, is_initial, number_of_spaces )
                        ...
                        # Update the source json
                        with open( source + f'/psxproject.json', 'w' ) as json_file:
                            json.dump( psxprj, json_file, indent=4 )
                            print(json_file)
                            if ( DEBUG ):
                                print( f'''
